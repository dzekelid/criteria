...
- name: Akamai API List Available Criteria
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/criteria/master/_listings/akamai/papi-v0-properties-propertyid-versions-propertyversion-available-criteria-get.md
x-common:
- type: x-base
